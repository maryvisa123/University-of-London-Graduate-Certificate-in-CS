...
class Creature:
    ...
    def update_position(self, pos):
        if self.start_position == None:
            ...
            # Check if the current altitude (Z-coordinate) is higher than the previous altitude
            # and also higher than the current max_altitude
            if pos[2] > self.last_position[2] and pos[2] > self.max_altitude:
                self.max_altitude = pos[2]
    ...
    def get_max_altitude(self):
        """Return the maximum altitude reached by the creature."""
